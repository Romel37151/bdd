...
select * from transacciones
where tipo ='D' and fecha= date( '25/5/2024') and( numero_cuenta between '22007' and '22010')


select * from transacciones
where codigo between '1' and '5' and (numero_cuenta between '22002' and '22004') and fecha=date('26/05/2024') or fecha =date('29/05/2024')
