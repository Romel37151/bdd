...
select * from registros_entrada
where (fecha between '1/9/2024'and '30/9/2024') or cedula_empleado like '17%'


select * from registros_entrada
where (fecha between '1/8/2024'and '31/8/2024') and hora between '8:00' and '12:00'

select * from registros_entrada
where ((fecha between '1/8/2024'and '31/8/2024') and hora between '8:00' and '12:00')
or (fecha between '1/9/2024'and '30/9/2024' and cedula_empleado like '08%' and hora between '9:00'and '13:00')
